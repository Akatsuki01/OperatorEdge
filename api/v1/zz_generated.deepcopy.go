...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeVital) DeepCopyInto(out *EdgeVital) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeVital.
func (in *EdgeVital) DeepCopy() *EdgeVital {
	if in == nil {
		return nil
	}
	out := new(EdgeVital)
